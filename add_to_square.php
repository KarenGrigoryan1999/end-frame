...
h1 { 
  ...
  font-size = 3;
    ...
    <body>
        <H3>Добавление площадки</H3>
        <form action = "add_to_base_of_square.php" method = "POST">
            <table>
                <tr>
            ...
            <tr>
                <td width = "30%">Введите адресс:</td>
                <td width = "40%"><input type = 'text' name = "address" value = ""/></td>
            </tr>
            </table>
